...
# select our four countries
pollution_nations <-
  pollution |>
  group_by(Country.Name) |>
  filter(Country.Name == c('United States', 'Japan', 'Pakistan', 'Vietnam'))

# fit a model
nations_fit <-
 linear_reg() |>
  fit((Country.GDP) ~  Emissions.Production.CO2.Total, pollution_nations) 

# the model
tidy(nations_fit)

# determine p-value with 95% confidence
